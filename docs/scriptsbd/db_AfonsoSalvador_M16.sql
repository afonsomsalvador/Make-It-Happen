...
CREATE TABLE IF NOT EXISTS `PSI18_AfonsoSalvador`.`Publicar` (
  `idPublicar` INT NOT NULL DEFAULT 1,
  `publicacao` VARCHAR(280) NULL,
  `Login_id_user` INT NOT NULL,
  `Login_Pais_idPais` INT NOT NULL,
  PRIMARY KEY (`idPublicar`, `Login_id_user`, `Login_Pais_idPais`),
...
CREATE TABLE IF NOT EXISTS `PSI18_AfonsoSalvador`.`Organizacao` (
  `idOrganizacao` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `PSI18_AfonsoSalvador`.`localidade` (
  `idlocalidade` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `PSI18_AfonsoSalvador`.`Voluntariado` (
  `idVoluntariado` INT NOT NULL DEFAULT 1,
  ...
  PRIMARY KEY (`idVoluntariado`, `localidade_idlocalidade`, `Detalhes_idDetalhes`, `Detalhes_localidade_idlocalidade`, `Categorias_id_Categoria`),
  INDEX `fk_Voluntariado_localidade1_idx` (`localidade_idlocalidade` ASC),
  INDEX `fk_Voluntariado_Detalhes1_idx` (`Detalhes_idDetalhes` ASC, `Detalhes_localidade_idlocalidade` ASC),
...
CREATE TABLE IF NOT EXISTS `PSI18_AfonsoSalvador`.`Experiencia` (
  `idExperiencia` INT NOT NULL DEFAULT 1,
